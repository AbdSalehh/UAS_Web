                        ...
                        <form class="row" enctype="multipart/form-data" wire:submit.prevent="addProduct">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control input-md"
                                        placeholder="Masukkan Nominal depan, Contoh : 30" wire:model="regular_price">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control input-md"
                                        placeholder="Masukkan Nominal depan, Contoh : 30" wire:model="sale_price">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    <label>SKU</label>
                                    <input type="text" class="form-control input-md" placeholder="exp : DIGI131"
                                        wire:model="SKU">
                                </div>
                            </div>
                            <div class="col-6">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control input-md" placeholder="Exp : 171"
                                        wire:model="quantity">
                                </div>
                            </div>
                            <div class="col-6">
